...
import { assertIsValidKey, getColumnMetrics, getColumnScrollPosition, getHorizontalRangeToRender, getScrollbarSize, getVerticalRangeToRender, getViewportColumns, getNextSelectedCellPosition, isSelectedCellEditable, canExitGrid, isCtrlKeyHeldDown } from './utils';
...
editorPortalTarget = document.body, rowClass }, ref) {
    ...
    function getViewportRows() {
        ...
        for (let rowIdx = rowOverscanStartIdx; rowIdx <= rowOverscanEndIdx; rowIdx++) {
            ...
            rowElements.push(React.createElement(RowRenderer, { key: key, rowIdx: rowIdx, row: row, viewportColumns: viewportColumns, lastFrozenColumnIndex: lastFrozenColumnIndex, eventBus: eventBus, isRowSelected: isRowSelected, onRowClick: onRowClick, rowClass: rowClass, top: rowIdx * rowHeight + totalHeaderHeight, copiedCellIdx: (copiedPosition === null || copiedPosition === void 0 ? void 0 : copiedPosition.rowIdx) === rowIdx ? copiedPosition.idx : undefined, draggedOverCellIdx: getDraggedOverCellIdx(rowIdx), setDraggedOverRowIdx: isDragging ? setDraggedOverRowIdx : undefined, selectedCellProps: getSelectedCellProps(rowIdx) }));
        }
        return rowElements;
    }
    ...
    return (React.createElement("div", { className: clsx('rdg', { 'rdg-viewport-dragging': isDragging }), style: {
            width,
            height,
